...
- **Configuration presets** - Define reusable avatar configurations
...
- **PHP 8.4 features** - Full support for property hooks, enums, and modern PHP
...
- **[Configuration](configuration.md)** - Set up presets and customize defaults
